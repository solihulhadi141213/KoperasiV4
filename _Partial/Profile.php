<li class="nav-item dropdown pe-3">
    <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
        <?php
            echo '
                <img src="assets/img/User/'.$SessionGambar.'" alt="Iamge Profile" class="rounded-circle profile-img">
                <span class="d-none d-md-block dropdown-toggle ps-2 text-white">'.$SessionNama.'</span>
            ';
        ?>
    </a>
