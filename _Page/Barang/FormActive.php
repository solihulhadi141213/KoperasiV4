    ...
    <div class="row mb-3">
        <div class="col-12">
            <div class="alert alert-info text-center">
                <small>
                    <b>PENTING!</b><br>
                    Mengaktifkan barang ini mungkin akan mengembalikan riwayat data transaksi untuk barang tersebut<br>
                    <b>Apakah anda yakin akan mengaktifkan barang tersebut?</b>
                </small>
            </div>
        </div>
    </div>