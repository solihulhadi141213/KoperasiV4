    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <form action="javascript:void(0);" id="ProsesTambahFitur" autocomplete="off">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control kode_fitur" name="kode" id="kode">
                                <button type="button" class="btn btn-dark generate_kode_fitur" title="Generate Kode" id="GenerateKode">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary" id="ButtonTambahAksesFitur">
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <form action="javascript:void(0);" id="ProsesEditFitur" autocomplete="off">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary" id="ButtonEditFitur">
                        <i class="bi bi-save"></i> Simpan
                    </button>
                    <button type="button" class="btn btn-dark" data-bs-dismiss="modal">
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <form action="javascript:void(0);" id="ProsesHapusFitur" autocomplete="off">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary" id="ButtonHapusFitur">
...
<div class="modal fade" id="ModalEntitas" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-dark"><i class="bi bi-info-circle"></i> Daftar Entitas</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12" id="FormEntitas">
                        <!-- Form Entitas -->
                    </div>
                </div>
            </div>
...
<div class="modal fade" id="ModalPengguna" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-dark"><i class="bi bi-info-circle"></i> Daftar Pengguna</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="row">
