<?php
    ...
    if(!IjinAksesSaya($Conn, $SessionIdAkses, 'rA8MRFArw1qPeVySjAC')){
                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col-12 text-end">
                                ...
                                <button type="button" class="btn btn-md btn-primary btn-floating" data-bs-toggle="modal" data-bs-target="#ModalTambahFitur" title="Tambah Fitur Aplikasi">
