...
?>
    ...
    <div class="row mb-3">
        <div class="col-md-12">
            <label for="nama_akses_edit"><small>Nama Akses/Entitas</small></label>
            <input type="text" name="akses" id="nama_akses_edit" class="form-control" value="<?php echo $NamaAkses; ?>">
        </div>
    </div>
    <div class="row mb-3">
        <div class="col-md-12">
            <label for="keterangan_edit"><small>Keterangan</small></label>
            <textarea name="keterangan" id="keterangan_edit" class="form-control"><?php echo $KeteranganEntitias; ?></textarea>
        </div>
    </div>