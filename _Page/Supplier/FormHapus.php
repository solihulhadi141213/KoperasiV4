    ...
    <div class="row mb-3">
        <div class="col-12">
            <div class="alert alert-danger text-center">
                <small>
                    <b>PENTING!</b><br>
                    Menghapus data supplier mungkin akan menyebabkan data riwayat transaksi keuangan bersangkutan akan ikut terhapus.<br>
                    <b>Apakah anda yakin akan menghapus supplier tersebut?</b>
                </small>
            </div>
        </div>
    </div>
