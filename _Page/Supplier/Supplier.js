...
$(document).ready(function() {
    ...
    $('#KeywordBy').change(function(){
        ...
        $.ajax({
            type       : 'POST',
            url        : '_Page/Supplier/FormFilter.php',
    ...
    // Tom Select kategori_supplier
    new TomSelect('#kategori_supplier', {
    ...
    $('#ProsesTambah').submit(function(e){
        ...
        $.ajax({
            type       : 'POST',
            url        : '_Page/Supplier/ProsesTambah.php',
            data       : formData,
            processData: false,
            contentType: false,
            dataType   : 'JSON',
    ...
    $('#ModalDetail').on('shown.bs.modal', function (e) {
        ...
        $.ajax({
            type   : 'POST',
            url    : '_Page/Supplier/FormDetail.php',
    ...
    $('#ModalEdit').on('shown.bs.modal', function (e) {
        ...
        // Tangkap ID Supplier
        let id_supplier = $(e.relatedTarget).data('id');
        ...
        $.ajax({
            type   : 'POST',
            url    : '_Page/Supplier/FormEdit.php',
            data   : { id_supplier: id_supplier },
            success: function (response) {
    ...
    $('#ProsesEdit').submit(function(e){
        ...
        $.ajax({
            type       : 'POST',
            url        : '_Page/Supplier/ProsesEdit.php',
            data       : formData,
            processData: false,
            contentType: false,
            dataType   : 'JSON',
    ...
    $('#ModalHapus').on('shown.bs.modal', function (e) {
        ...
        $.ajax({
            type   : 'POST',
            url    : '_Page/Supplier/FormHapus.php',
            data   : {id_supplier: id_supplier},
            success: function (data) {
                // Fade out kecil sebelum ganti content
    ...
    $('#ProsesHapus').submit(function(e){
        ...
        $.ajax({
            type       : 'POST',
            url        : '_Page/Supplier/ProsesHapus.php',
            data       : formData,
            processData: false,
            contentType: false,
            dataType   : 'JSON',
    ...
    $('#ModalInactive').on('shown.bs.modal', function (e) {
        ...
        $.ajax({
            type   : 'POST',
            url    : '_Page/Supplier/FormInactive.php',
            data   : {id_supplier: id_supplier},
            success: function (data) {
                // Fade out kecil sebelum ganti content
    ...
    $('#ProsesInactive').submit(function(e){
        ...
        $.ajax({
            type       : 'POST',
            url        : '_Page/Supplier/ProsesInactive.php',
            data       : formData,
            processData: false,
            contentType: false,
            dataType   : 'JSON',
    ...
    $('#ModalActive').on('shown.bs.modal', function (e) {
        ...
        $.ajax({
            type   : 'POST',
            url    : '_Page/Supplier/FormActive.php',
            data   : {id_supplier: id_supplier},
            success: function (data) {
                // Fade out kecil sebelum ganti content
    ...
    $('#ProsesActive').submit(function(e){
        ...
        $.ajax({
            type       : 'POST',
            url        : '_Page/Supplier/ProsesActive.php',
            data       : formData,
            processData: false,
            contentType: false,
            dataType   : 'JSON',
    ...
    $('#ProsesImport').submit(function(e){
        ...
        $.ajax({
            url         : '_Page/Supplier/ImportPreview.php',
            type        : 'POST',
            data        : formData,
            processData : false,
            contentType : false,
