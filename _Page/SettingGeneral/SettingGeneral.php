                        ...
                        <div class="row mb-3">
                            <div class="col-12 mb-3 text-center">
                                <div class="d-flex align-items-center justify-content-center" style="height:220px;" id="FaviconPreview">
                                    <?php
                                        if(!empty($favicon)){
                                            echo '<img src="assets/img/icon/'.$favicon.'" alt="Favicon" class="img-fluid" style="max-height:200px;">';
                                        }else{
                        ...
                        <div class="row mb-3">
                            <div class="col-12 mb-3 text-center">
                                <div class="d-flex align-items-center justify-content-center" style="height:220px;" id="LogoPreview">
                                    <?php
                                        if(!empty($logo)){
                                            echo '<img src="assets/img/icon/'.$logo.'" alt="Logo" class="img-fluid" style="max-height:200px;">';
                                        }else{
