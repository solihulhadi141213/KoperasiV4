$(document).ready(function() {
    ...
    // IJIN AKSES PENGGUNA
    function ShowIjinAkses(){
        $('#izin_akses_pengguna').html("Loading...");
        
        // Buka Form Dengan AJAX
        $.ajax({
            type 	    : 'POST',
            url 	    : '_Page/MyProfile/izin_akses_pengguna.php',
            success     : function(data){
                $('#izin_akses_pengguna').html(data);
            }
        });
    }
    ...
    // Menampilkan Ijin Akses Pengguna
    ShowIjinAkses();
