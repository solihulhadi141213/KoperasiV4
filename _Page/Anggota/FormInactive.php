...
?>
    ...
    <div class="row mb-3">
        <div class="col-md-12">
            <label for="tanggal_inactive"><small>Tanggal</small></label>
            <input type="date" class="form-control" name="tanggal_inactive" id="tanggal_inactive"value="<?php echo date('Y-m-d'); ?>" >
        </div>
    </div>
    <div class="row mb-3">
        <div class="col-md-12">
            <label for="jam_inactive"><small>Jam</small></label>
            <input type="time" class="form-control" name="jam_inactive" id="jam_inactive"value="<?php echo date('H:i'); ?>" >
        </div>
    </div>
