    ...
    <div class="row mb-3">
        <div class="col-12">
            <div class="alert alert-info text-center">
                <small>
                    <b>PENTING!</b><br>
                    Mengaktifkan anggota ini mungkin akan mengembalikan riwayat data transaksi keuangan yang pernah dilakukan<br>
                    <b>Apakah anda yakin akan mengaktifkan anggota tersebut?</b>
                </small>
            </div>
        </div>
    </div>
