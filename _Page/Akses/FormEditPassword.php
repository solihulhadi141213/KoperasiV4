...
<div class="row mb-3">
    <div class="col-md-12">
        ...
        <input type="password" class="form-control" name="password_edit_1" id="password_edit">
    </div>
</div>
<div class="row mb-3">
    <div class="col-md-12">
        <label for="password_edit2">Ulangi Password</label>
        <input type="password" class="form-control" name="password_edit_2" id="password_edit2">
    </div>
</div>
<div class="row mb-3">
    <div class="col-12">
        <div class="form-check mb-2">
            <input class="form-check-input" type="checkbox" id="tampilkan_password_edit">
            <label class="form-check-label" for="tampilkan_password_edit"><small>Tampilkan Password</small></label>
        </div>
    </div>
</div>