<?php
    ...
    if (!empty($keyword)) {
        ...
        if (!empty($keyword_by)) {
            ...
            $where .= "
                WHERE (
                    akses.nama_akses LIKE ? OR 
                    akses.kontak_akses LIKE ? OR
                    akses.email LIKE ? OR
                    akses.akses LIKE ? OR
                    akses.datetime_daftar LIKE ?
                )
            ";
    ...
    $sql = "
        SELECT 
            akses.*,
            COUNT(akses_ijin.id_akses_ijin) AS jumlah_fitur
        FROM akses
        LEFT JOIN akses_ijin 
            ON akses.id_akses = akses_ijin.id_akses
        $where
        GROUP BY akses.id_akses
        ORDER BY akses.$OrderBy $ShortBy
        LIMIT ?, ?
    ";
