        ...
        <div class="modal-content">
            <form action="javascript:void(0);" id="ProsesTambah" autocomplete="off">
                ...
                <div class="modal-body">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <label for="uuid_akses_entitas">Level/Entitas</label>
                            <select name="uuid_akses_entitas" id="uuid_akses_entitas" class="form-control">
                                <option value="">Pilih</option>
                                <?php
                                    ...
                                    while ($data = mysqli_fetch_array($query)) {
                                        ...
                                        $akses              = $data['akses'];
                                        echo '<option value="'.$uuid_akses_entitas.'">'.$akses.'</option>';
                                    }
                                ?>
                            </select>
                        </div>
