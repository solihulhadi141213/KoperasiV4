<div class="pagetitle">
    <h1>
        <a href="">
            <i class="bi bi-person-circle"></i> Akses Pengguna</a>
        </a>
    </h1>
    <nav>
        <ol class="breadcrumb">
                    ...
                    <form action="javascript:void(0);" id="ProsesBatas">
                        <div class="row">
                            <div class="col-12 mb-3 text-end">
                                ...
                                <button type="button" class="btn btn-md btn-primary btn-floating" data-bs-toggle="modal" data-bs-target="#ModalTambah" title="Tambah Entitas Akses">
                        ...
                        <table class="table table-hover table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <td><b><small>Nama Pengguna</small></b></td>
                                    <td><b><small>Email</small></b></td>
                                    <td><b><small>Kontak</small></b></td>
                                    <td class="text-center"><b><small>Level/Entitas</small></b></td>
                                    <td class="text-center"><b><small>Fitur</small></b></td>
