...
$(document).ready(function() {
    ...
    $('#ProsesTambah').submit(function(e){
        ...
        $.ajax({
            type       : 'POST',
            url        : '_Page/Akses/ProsesTambah.php',
            data       : formData,
            processData: false,
            contentType: false,
            dataType   : 'JSON',
    ...
    $('#ModalDetail').on('shown.bs.modal', function (e) {
        ...
        $.ajax({
            type   : 'POST',
            url    : '_Page/Akses/FormDetail.php',
    ...
    $('#ProsesEdit').submit(function(e){
        ...
        $.ajax({
            type    : 'POST',
            url     : '_Page/Akses/ProsesEdit.php',
            data    : formData,
            dataType: 'JSON',
            success : function(response){
                console.log(response);
    ...
    $('#ModalEditFoto').on('shown.bs.modal', function (e) {
        ...
        $.ajax({
            type   : 'POST',
            url    : '_Page/Akses/FormEditFoto.php',
            data   : {id_akses: id_akses},
            success: function (data) {
                // Fade out kecil sebelum ganti content
    ...
    $('#ProsesHapus').submit(function(e){
        ...
        $.ajax({
            type       : 'POST',
            url        : '_Page/Akses/ProsesHapus.php',
            data       : formData,
            processData: false,
            contentType: false,
            dataType   : 'JSON',
